...
var render = function() {
  ...
  return !_vm.player
    ? _c("div", [
        _c("p", [_vm._v("Search for a player")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
        ...
        _vm._v(" "),
        _c("button", { on: { click: _vm.doSearch } }, [_vm._v("Search")]),
        _vm._v(" "),
        _vm.errors
          ? _c(
              "ul",
    ...
    : _c(
        "div",
        [
          _c("h1", [_vm._v(_vm._s(_vm.search))]),
          _vm._v(" "),
          _c("h3", [_vm._v("Combat level: " + _vm._s(_vm.player.combat))]),
          _vm._v(" "),
          _vm._l(_vm.player.activities, function(activity) {
            return _c("div", [
              _c("p", [
                _c("strong", [
                  _vm._v(
                  ...
                  _c("small", [_vm._v(_vm._s(activity.date))])
                ]),
                _vm._v(" "),
                _c("br"),
                _vm._v(
                  "\n            " + _vm._s(activity.details) + "\n        "
                )
              ])
            ])
          }),
          ...
          _c(
            "button",
            { staticClass: "close", on: { click: _vm.resetPlayer } },
            [_vm._v("Back to main")]
          )
        ],
        2
...
__webpack_require__(/*! /home/vagrant/code/rsapp/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/vagrant/code/rsapp/resources/sass/app.scss */"./resources/sass/app.scss");
